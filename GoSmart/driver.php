...
<div class="cont_ba_opcitiy">
  ...
  <p>Register your account by giving details.</p>
...
<button class="btn_login" onclick="cambiar_login()"formaction=" index.php">LOGIN</button>
</form>
</div>
...
<h2>SIGN UP</h2>
 ...
 <br> <br> <br>
 <h3> Signup into our website by giving your details </h3> <br><br>
<button name="submit" class="btn_sign_up" onclick="cambiar_sign_up()" action="signup.php"  >SIGN UP</button>
</form>
