...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="logo"><a href="index.html"><img src="https://cdn.dribbble.com/users/81224/screenshots/487291/dribbbletaxi.png"" width="100">SMART</a></div>
                </div>
      ...
      <div class="row">
          <div class="col-md-6">
            <div class="book_now">
              ...
              <h1 class="call_text">(+91) 9099334123</h1>
            </div>
            ...
            <div class="input_main">
              <div class="container">
                ...
                <div class="form-group">
                  <input type="text" class="email-bt" placeholder="PICKUP LOCATION" name="Name">
                </div>
                <div class="form-group">
                  <input type="text" class="email-bt" placeholder="DROP LOCATION" name="Email">
                </div>
                <div class="form-group">
    ...
    <div class="carousel-item">
      <div class="row">
          <div class="col-md-6">
            <div class="book_now">
              <h1 class="book_text">BOOK NOW</h1>
              <h1 class="call_text">(+91) 9234565712 </h1>
            </div>
  ...
  <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
    ...
    <div id="booking" class="ride_section layout_padding">
      <div class="container">
        <div class="ride_main">
          <h1 class="ride_text">Why Ride <span style="color: #f4db31;">With <BR> GO SMART</span></h1> <br>
      </div>
        </div>
      ...
      <div class="container-fluid">
        <div class="location_main">
          <div class="row">
            ...
            <div class="col-sm-5">
              <div class="download_text">SELECT LOCATION<br><span style="color: #fffcf4;">BOOK RIDE TODAY</span></div>
            </div>
            <div class="col-sm-3">
              <div class=""><img src="images/img-7.png"></div>
            </div>
          </div>
        </div>
      </div>
